...
@export var color1: Color = Color.GOLD:
    set(v): color1 = v; _generate_deco()
@export var color2: Color = Color.CORAL:
    set(v): color2 = v; _generate_deco()
@export var color3: Color = Color.ORANGE:
...
func _generate_deco():
    ...
    shape_stack = [tri_top_params, tri_right_params, tri_left_params]
