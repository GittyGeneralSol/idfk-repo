...
@export var outline_width: float = 15.0
...
func _draw():
    ...
    var points_outline: PackedVector2Array = HypocycloidGenerator.generate_hypocycloid_points(num_points, circumrad + outline_width, 360, center_offset, rotation_deg) # Outline
